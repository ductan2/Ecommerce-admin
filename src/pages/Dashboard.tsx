      ...
      <section className="content-main">
        ...
        <div className="row">
          <div className="col-lg-3">
            <div className="card card-body mb-4">
              <article className="icontext">
                <span className="icon icon-sm rounded-circle bg-primary-light center-flex"><i className="text-primary material-icons md-monetization_on"></i></span>
                <div className="text">
          ...
          <div className="col-lg-3">
            <div className="card card-body mb-4">
              <article className="icontext">
                <span className="icon icon-sm rounded-circle bg-success-light center-flex"><i className="text-success material-icons md-local_shipping"></i></span>
                <div className="text">
          ...
          <div className="col-lg-3">
            <div className="card card-body mb-4">
              <article className="icontext">
                <span className="icon icon-sm rounded-circle bg-warning-light center-flex"><i className="text-warning material-icons md-qr_code"></i></span>
                <div className="text">
          ...
          <div className="col-lg-3">
            <div className="card card-body mb-4">
              <article className="icontext">
                <span className="icon icon-sm rounded-circle bg-info-light center-flex"><i className="text-info material-icons md-shopping_basket"></i></span>
                <div className="text">
          ...
          <div className="col-xl-8 col-lg-12">
            <div className="card mb-4">
              <article className="card-body">
                ...
                <canvas id="myChart" height="345" width="863" style={{ display: "block", boxSizing: "border-box", height: "275px", width: "680px" }}></canvas>
              </article>
            </div>
            <div className="row">
                    ...
                    <div className="new-member-list">
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          <img src="assets/imgs/people/avatar-4.png" alt="" className="avatar" />
                          <div>
                            <h6>Patric Adams</h6>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          <img src="assets/imgs/people/avatar-2.png" alt="" className="avatar" />
                          <div>
                            <h6>Dilan Specter</h6>
                            <p className="text-muted font-xs">Sanfrancisco</p>
                          </div>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          <img src="assets/imgs/people/avatar-3.png" alt="" className="avatar" />
                          <div>
                            <h6>Tomas Baker</h6>
                            <p className="text-muted font-xs">Sanfrancisco</p>
                          </div>
          ...
          <div className="col-xl-4 col-lg-12">
            <div className="card mb-4">
              <article className="card-body">
                ...
                <canvas id="myChart2" height="623" width="863" style={{ display: "block", boxSizing: "border-box", height: "275px", width: "680px" }}></canvas>
              </article>
            </div>
            <div className="card mb-4">
              <article className="card-body">
            ...
            <div className="row align-items-center">
              <div className="col-md-3 col-12 me-auto mb-md-0 mb-3">
                <div className="custom_select">
                  <select className="form-select select-nice select2-hidden-accessible" data-select2-id="1" tabIndex={-1} aria-hidden="true">
                  ...
                  <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style={{ width: "257.712px" }}>
                    <span className="selection"><span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex={0} aria-labelledby="select2-4uqm-container"><span className="select2-selection__rendered" id="select2-4uqm-container" role="textbox" aria-readonly="true" title="All Categories">All Categories</span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span className="dropdown-wrapper" aria-hidden="true"></span>
                  </span>
                </div>
              </div>
              ...
              <div className="col-md-2 col-6">
                <div className="custom_select">
                  <select className="form-select select-nice select2-hidden-accessible" data-select2-id="4" aria-hidden="true">
                    <option data-select2-id="6">Status</option>
                    <option>All</option>
                    <option>Paid</option>
                    <option>Chargeback</option>
                    <option>Refund</option>
                  </select>
                  <span className="select2 select2-container select2-container--default" dir="ltr" data-select2-id="5" style={{ width: "163.8px" }}>
                    <span className="selection"><span className="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabIndex={0} aria-labelledby="select2-ag0v-container"><span className="select2-selection__rendered" id="select2-ag0v-container" role="textbox" aria-readonly="true" title="Status">Status</span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span className="dropdown-wrapper" aria-hidden="true"></span>
                  </span>
                </div>
              </div>
            </div>
